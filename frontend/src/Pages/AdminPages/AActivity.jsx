...
const AActivity = () => {
  ...
  const handleAddActivity = async () => {
    try {
      ...
      const response = await axios.post('http://35.232.49.147:3000/api/activity', activityToAdd);
  ...
  const handleEditActivity = async (activity) => {
    try {
      const response = await axios.put(`http://35.232.49.147:3000/api/activity/${activity.id}`, activity);
  ...
  const handleDeleteActivity = async (id) => {
    try {
      await axios.delete(`http://35.232.49.147:3000/api/activity/${id}`);
